...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert('Usuario registrado'); // Muestra un mensaje de éxito
        } catch (err) {
            console.error(err); // Muestra el error en la consola
            alert('Error al registrar'); // Muestra un mensaje de error
        }
    };

    // Renderiza el formulario de registro con estilos de Bootstrap
    return (
...
export default Register; // Exporta el componente para que pueda ser utilizado en otros lugares
